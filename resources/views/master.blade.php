    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/dashboard') }}">
                ...
                <div class="sidebar-brand-text mx-3">Pelindo <sup>Travel App</sup></div>
            </a>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li
                class="nav-item  {{ Request::segment(1) == 'jadwal' && Request::segment(2) != 'create' ? 'active' : '' }}">
            ...
            <li
                class="nav-item  {{ Request::segment(1) . '/' . Request::segment(2) == 'jadwal/create' ? 'active' : '' }}">
            ...
            <li class="nav-item  {{ Route::is('booking') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/booking') }}" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-calendar-plus"></i>
                    <span>Booking</span>
                </a>
