...
Route::get('/getAllPenumpang/{id}', 'PenumpangController@getAllPenumpang');
...
Route::get('/getAllBooking/{id}', 'BookingController@all');
...
Route::get('/setBatal/{id}', 'BookingController@batalkanBooking');



Route::post('/ubahProfil', 'UserController@updateProfil');

Route::get('/cetakTiket/{id}', 'LaporanController@cetakTiket');
